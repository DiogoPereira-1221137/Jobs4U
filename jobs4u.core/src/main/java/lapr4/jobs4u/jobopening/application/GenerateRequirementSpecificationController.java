...
/**
 * The type Generate requirement specification controller.
 */
@UseCaseController
public class GenerateRequirementSpecificationController {
...
//    public Iterable<Plugin> allRequirementSpecficationPlugin() {
//
//        authz.ensureAuthenticatedUserHasAnyOf(Roles.OPERATOR, Roles.CUSTOMER_MANAGER, Roles.ADMIN);
//
//        return this.repoPlugin.findPluginByType(PluginType.REQUIREMENTS);
//
//
//    }

    /**
     * Generate requirement specification template.
     *
     * @param jobOpening the job opening
     * @throws IOException the io exception
     */
    public void generateRequirementSpecificationTemplate(JobOpening jobOpening) throws Exception {

        Plugin plugin = jobOpening.requirementsPlugin();
        if (plugin==null){ throw new Exception("This JobOpening doesn't have an Requirement Model Plugin");}
        ...
        try {
            ...
            String filePath = "template/" + jobOpening.companyName().getId() + "_REQ_template.txt";
