...
public class RequirementsALexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DEGREE", "LANGUAGE", "WS", "PHRASE", "TEXT"
		};
	}
	...
	public RequirementsALexer(CharStream input) {
		super(input);
